  ...
  <div class="meetingcontrol">
    ...
    <div class="hcontrol">
      <transition name="fade">
        <b-button v-if="!controlbar" @click="toggleControlBar" icon-left="chevron-right" class="togglecontrolbar"></b-button>
      </transition>
      <transition name="fade-slide">
        <div v-if="controlbar">
          <b-button @click="toggleControlBar" icon-left="chevron-left"></b-button>
  ...
  methods: {
    ss(effect) {
      if (effect == "blur") {
        ...
        if (this.$parent.isblur) { this.$parent.isbgimg = false }
      }
      ...
      if (effect == "image") {
        ...
        if (this.$parent.isbgimg) { this.$parent.isblur = false }
      }
