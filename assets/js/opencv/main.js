...
import { SemanticSegmentationOpenCVRunner } from '~/assets/js/webnn-opencv/util/SemanticSegmentationOpenCVRunner'
import Renderer from '~/assets/js/webnn-opencv/webgl/DrawOutputs'
import Control from '~/components/Control.vue'
import Clock from '~/components/Clock.vue'

export default {
  name: 'OpenCV',
  layout: 'sceneryopencv',
  components: {
    Control,
    Clock
  },
  ...
  methods: {
    ...
    initRunner() {
      ...
      this.runner = new SemanticSegmentationOpenCVRunner()
